...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, BAOBAB_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.BOABAB_KEY),
                VegetationPlacedFeatures.treeModifiersWithWouldSurvive(
                        PlacedFeatures.createCountExtraModifier(2, 0.1f, 2), BlockRegistry.BOABAB_SAPLING));
    }
