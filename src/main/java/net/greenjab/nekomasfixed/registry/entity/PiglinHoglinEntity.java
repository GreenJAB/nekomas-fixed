...
public class PiglinHoglinEntity extends AbstractHorseEntity {
    ...
    protected void initCustomGoals() {
        ...
        this.goalSelector.add(2, new MeleeAttackGoal(this, 1.5D, true));
        this.goalSelector.add(3, new TemptGoal(this, 1.25D,
                (stack) -> stack.isOf(Items.GOLD_INGOT), false));
        this.goalSelector.add(3, new TemptGoal(this, (double)1.25F, (stack) -> stack.isIn(ItemTags.HOGLIN_FOOD), false));
    }
    ...
    public @Nullable EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        if (spawnReason == SpawnReason.NATURAL) {
            ...
            if (piglinentity != null) {
                ...
                piglinentity.equipStack(EquipmentSlot.MAINHAND, new ItemStack(Items.GOLDEN_SPEAR));
    ...
    static {
        BABY_BASE_DIMENSIONS = EntityType.HOGLIN.getDimensions().withAttachments(EntityAttachments.builder().add(EntityAttachmentType.PASSENGER, 0.0F, EntityType.HOGLIN.getHeight() - 0.03125F, 0.0F)).scaled(0.5F);
    }
}
