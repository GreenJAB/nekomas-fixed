...
public class DyedBrushItem extends Item {
    ...
    private static Block getTerracotta(DyeColor color) {
        return DyedBrushableBlocksMappings.TERRACOTTA.get(color);
    }
    ...
    private static Block getBricks(DyeColor color) {
        return DyedBrushableBlocksMappings.BRICKS.get(color);
    }
    private static Block getConcretes(DyeColor color) {
        return DyedBrushableBlocksMappings.CONCRETE.get(color);
    }
    private static Block getConcretePowders(DyeColor color) {
        return DyedBrushableBlocksMappings.CONCRETE_POWDER.get(color);
    }
    private static Block getWool(DyeColor color) {
        return DyedBrushableBlocksMappings.WOOL.get(color);
    }
