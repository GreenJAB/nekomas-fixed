...
public class CoralNautilusBlockEntity extends BlockEntity {
	private final List<AnimalComponent.StoredEntityData> animal = Lists.newArrayList();

	public CoralNautilusBlockEntity(BlockPos pos, BlockState state) {
		super(BlockEntityTypeRegistry.CORAL_NAUTILUS_BLOCK_ENTITY, pos, state);
	}
	...
	public boolean releaseAnimal(
		...
		Direction direction = state.get(CoralNautilusBlock.FACING);
