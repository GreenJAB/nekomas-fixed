...
public class BlockRegistry {
    ...
    public static final Block GOAT_HORN = register("horn", GoatHornBlock::new, AbstractBlock.Settings.create().noCollision().mapColor(MapColor.YELLOW).strength(0.2F).sounds(BlockSoundGroup.METAL).pistonBehavior(PistonBehavior.DESTROY));
