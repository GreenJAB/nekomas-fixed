...
public class BlockRegistry {
    ...
    public static final Block BOABAB_FRUIT = register("boabab_fruit", BoababFruitBlock::new, AbstractBlock.Settings.create().strength(0.2f).solidBlock(BlockRegistry::never).burnable().breakInstantly().noBlockBreakParticles());
