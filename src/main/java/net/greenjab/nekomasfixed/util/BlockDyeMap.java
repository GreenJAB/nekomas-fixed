...
public class BlockDyeMap {
    ...
    static {
        ...
        CANDLE.put(AllDyes.WHITE, Blocks.DYED_CANDLE.white());
        CANDLE.put(AllDyes.ORANGE, Blocks.DYED_CANDLE.orange());
        CANDLE.put(AllDyes.MAGENTA, Blocks.DYED_CANDLE.magenta());
        CANDLE.put(AllDyes.LIGHT_BLUE, Blocks.DYED_CANDLE.lightBlue());
        CANDLE.put(AllDyes.YELLOW, Blocks.DYED_CANDLE.yellow());
        CANDLE.put(AllDyes.LIME, Blocks.DYED_CANDLE.lime());
        CANDLE.put(AllDyes.PINK, Blocks.DYED_CANDLE.pink());
        CANDLE.put(AllDyes.GRAY, Blocks.DYED_CANDLE.gray());
        CANDLE.put(AllDyes.LIGHT_GRAY, Blocks.DYED_CANDLE.lightGray());
        CANDLE.put(AllDyes.CYAN, Blocks.DYED_CANDLE.cyan());
        CANDLE.put(AllDyes.PURPLE, Blocks.DYED_CANDLE.purple());
        CANDLE.put(AllDyes.BLUE, Blocks.DYED_CANDLE.blue());
        CANDLE.put(AllDyes.BROWN, Blocks.DYED_CANDLE.brown());
        CANDLE.put(AllDyes.GREEN, Blocks.DYED_CANDLE.green());
        CANDLE.put(AllDyes.RED, Blocks.DYED_CANDLE.red());
        CANDLE.put(AllDyes.BLACK, Blocks.DYED_CANDLE.black());
        ...
        TERRACOTTA.put(AllDyes.WHITE, Blocks.DYED_TERRACOTTA.white());
        TERRACOTTA.put(AllDyes.ORANGE, Blocks.DYED_TERRACOTTA.orange());
        TERRACOTTA.put(AllDyes.MAGENTA, Blocks.DYED_TERRACOTTA.magenta());
        TERRACOTTA.put(AllDyes.LIGHT_BLUE, Blocks.DYED_TERRACOTTA.lightBlue());
        TERRACOTTA.put(AllDyes.YELLOW, Blocks.DYED_TERRACOTTA.yellow());
        TERRACOTTA.put(AllDyes.LIME, Blocks.DYED_TERRACOTTA.lime());
        TERRACOTTA.put(AllDyes.PINK, Blocks.DYED_TERRACOTTA.pink());
        TERRACOTTA.put(AllDyes.GRAY, Blocks.DYED_TERRACOTTA.gray());
        TERRACOTTA.put(AllDyes.LIGHT_GRAY, Blocks.DYED_TERRACOTTA.lightGray());
        TERRACOTTA.put(AllDyes.CYAN, Blocks.DYED_TERRACOTTA.cyan());
        TERRACOTTA.put(AllDyes.PURPLE, Blocks.DYED_TERRACOTTA.purple());
        TERRACOTTA.put(AllDyes.BLUE, Blocks.DYED_TERRACOTTA.blue());
        TERRACOTTA.put(AllDyes.BROWN, Blocks.DYED_TERRACOTTA.brown());
        TERRACOTTA.put(AllDyes.GREEN, Blocks.DYED_TERRACOTTA.green());
        TERRACOTTA.put(AllDyes.RED, Blocks.DYED_TERRACOTTA.red());
        TERRACOTTA.put(AllDyes.BLACK, Blocks.DYED_TERRACOTTA.black());
        ...
        SHULKER_BOX.put(AllDyes.WHITE, Blocks.DYED_SHULKER_BOX.white());
        SHULKER_BOX.put(AllDyes.ORANGE, Blocks.DYED_SHULKER_BOX.orange());
        SHULKER_BOX.put(AllDyes.MAGENTA, Blocks.DYED_SHULKER_BOX.magenta());
        SHULKER_BOX.put(AllDyes.LIGHT_BLUE, Blocks.DYED_SHULKER_BOX.lightBlue());
        SHULKER_BOX.put(AllDyes.YELLOW, Blocks.DYED_SHULKER_BOX.yellow());
        SHULKER_BOX.put(AllDyes.LIME, Blocks.DYED_SHULKER_BOX.lime());
        SHULKER_BOX.put(AllDyes.PINK, Blocks.DYED_SHULKER_BOX.pink());
        SHULKER_BOX.put(AllDyes.GRAY, Blocks.DYED_SHULKER_BOX.gray());
        SHULKER_BOX.put(AllDyes.LIGHT_GRAY, Blocks.DYED_SHULKER_BOX.lightGray());
        SHULKER_BOX.put(AllDyes.CYAN, Blocks.DYED_SHULKER_BOX.cyan());
        SHULKER_BOX.put(AllDyes.PURPLE, Blocks.DYED_SHULKER_BOX.purple());
        SHULKER_BOX.put(AllDyes.BLUE, Blocks.DYED_SHULKER_BOX.blue());
        SHULKER_BOX.put(AllDyes.BROWN, Blocks.DYED_SHULKER_BOX.brown());
        SHULKER_BOX.put(AllDyes.GREEN, Blocks.DYED_SHULKER_BOX.green());
        SHULKER_BOX.put(AllDyes.RED, Blocks.DYED_SHULKER_BOX.red());
        SHULKER_BOX.put(AllDyes.BLACK, Blocks.DYED_SHULKER_BOX.black());
