...
public class ConfigTrial {
    ...
    public static Screen createConfigScreen(Screen parentScreen) {
        ...
        ConfigCategory netherCategory = builder.getOrCreateCategory(Text.literal("Main Features"));
        ...
        netherCategory.addEntry(entryBuilder.startStrField(Text.literal("Enter your name"), currentValue.get())
