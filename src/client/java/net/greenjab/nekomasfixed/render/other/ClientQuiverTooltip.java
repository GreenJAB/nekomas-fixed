...
public class ClientQuiverTooltip implements ClientTooltipComponent {
    ...
    public ClientQuiverTooltip(final QuiverContents contents) {
    ...
    public void extractImage(final Font font, final int x, final int y, final int w, final int h, final GuiGraphicsExtractor graphics) {
            ...
            if (this.contents.isEmpty()) {
                ...
                this.extractBundleWithItemsTooltip(font, x, y, w, h, graphics, Fraction.getFraction(contents.getTotalArrowCount(), QuiverContents.MAX_ARROWS));
            }
