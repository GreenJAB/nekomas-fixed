...
public class TargetDummyEntityModel extends TargetDummyArmorEntityModel {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition modelPartData0 = modelPartData.addOrReplaceChild(
				PartNames.LEFT_ARM,
		...
		modelPartData0.addOrReplaceChild(
				"left_sleeve", CubeListBuilder.create().texOffs(48, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, dilation.extend(0.25F)), PartPose.ZERO
		);
		modelPartData1.addOrReplaceChild(
				"right_sleeve", CubeListBuilder.create().texOffs(40, 32).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, dilation.extend(0.25F)), PartPose.ZERO
		);
		...
		modelPartData2.addOrReplaceChild(
				"left_pants", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, dilation.extend(0.25F)), PartPose.ZERO
		);
		modelPartData3.addOrReplaceChild(
				"right_pants", CubeListBuilder.create().texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, dilation.extend(0.25F)), PartPose.ZERO
		);
		PartDefinition modelPartData4 = modelPartData.getChild(PartNames.BODY);
		modelPartData4.addOrReplaceChild(
				PartNames.JACKET, CubeListBuilder.create().texOffs(16, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, dilation.extend(0.25F)), PartPose.ZERO
		);
