...
public class CustomMinecartEntityModel extends MinecartEntityModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        group.addChild("base", ModelPartBuilder.create().uv(0, 11).cuboid(-11.0F, -1.0F, -9.0F, 22.0F, 1.0F, 18.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 6.0556F, 0.0F));
        ...
        top.addChild("cube_r1", ModelPartBuilder.create().uv(2, 75).cuboid(-1.0F, -3.5F, -1.0F, 2.0F, 8.0F, 1.0F, new Dilation(0.1F))
        ...
        top.addChild("cube_r2", ModelPartBuilder.create().uv(2, 9).cuboid(-0.5F, -3.5F, -7.0F, 1.0F, 7.0F, 14.0F, new Dilation(0.0F)), ModelTransform.of(9.7456F, 1.3073F, 0.4385F, 0.0F, 0.0F, 0.0873F));

        top.addChild("cube_r3", ModelPartBuilder.create().uv(2, 74).cuboid(-1.0F, -3.5F, 0.0F, 2.0F, 8.0F, 1.0F, new Dilation(0.1F))
        ...
        top.addChild("cube_r4", ModelPartBuilder.create().uv(2, 74).cuboid(0.0F, -3.5F, 0.0F, 1.0F, 8.0F, 1.0F, new Dilation(0.1F))
        ...
        top.addChild("cube_r5", ModelPartBuilder.create().uv(3, 4).cuboid(-10.0F, -3.5F, -0.5F, 20.0F, 7.0F, 1.0F, new Dilation(0.01F)), ModelTransform.of(0.5456F, 1.2573F, 7.4885F, -0.1309F, 0.0F, 0.0F));

        top.addChild("cube_r6", ModelPartBuilder.create().uv(16, 8).mirrored().cuboid(-0.5F, -3.5F, -7.0F, 1.0F, 7.0F, 14.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-8.6794F, 1.3073F, 0.4385F, 0.0F, 0.0F, -0.0873F));

        top.addChild("cube_r7", ModelPartBuilder.create().uv(2, 75).cuboid(0.0F, -3.5F, -1.0F, 1.0F, 8.0F, 1.0F, new Dilation(0.1F))
        ...
        top.addChild("cube_r8", ModelPartBuilder.create().uv(2, 18).cuboid(-10.0F, -3.5F, -0.5F, 20.0F, 7.0F, 1.0F, new Dilation(0.01F)), ModelTransform.of(0.5456F, 1.2573F, -6.6115F, 0.1309F, 0.0F, 0.0F));

        top.addChild("front_tile", ModelPartBuilder.create().uv(3, 14).cuboid(-1.0F, -1.0F, -7.0F, 2.0F, 2.0F, 14.0F, new Dilation(0.0F)), ModelTransform.origin(-9.4544F, -3.1927F, 0.4385F));

        ModelPartData chain = group.addChild("chain", ModelPartBuilder.create(), ModelTransform.origin(-2.4375F, 4.7569F, 0.5F));

        chain.addChild("chain_w_hook", ModelPartBuilder.create().uv(3, 6).mirrored().cuboid(-3.875F, -0.5F, 0.5F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        separate_chain.addChild("cube_r9", ModelPartBuilder.create().uv(3, 6).mirrored().cuboid(-0.75F, -0.5F, -1.5F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
        ...
        chain.addChild("hook", ModelPartBuilder.create().uv(3, 71).cuboid(-0.5F, 0.5F, -0.5F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F))
        ...
        wheels.addChild("wheel1", ModelPartBuilder.create().uv(2, 47).cuboid(-1.5F, -1.5F, 0.8333F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
        ...
        wheels.addChild("wheel2", ModelPartBuilder.create().uv(14, 48).cuboid(-1.5F, -1.5F, 0.8333F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
        ...
        wheels.addChild("wheel3", ModelPartBuilder.create().uv(15, 49).cuboid(-1.5F, -1.5F, 0.8333F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
        ...
        wheels.addChild("wheel4", ModelPartBuilder.create().uv(7, 38).cuboid(-1.5F, -1.5F, 0.8333F, 3.0F, 3.0F, 1.0F, new Dilation(0.0F))
        ...
        group.addChild("foundation", ModelPartBuilder.create().uv(9, 11).cuboid(-10.0F, -1.0F, -3.0F, 20.0F, 3.0F, 6.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 7.0556F, 0.0F));
        return TexturedModelData.of(modelData, 68, 86);
    }

    public void setAngles(MinecartEntityRenderState state) {
        super.setAngles(state);
        float rotation = state.age*3;
